...
class BlueSamplePipeline : OpenCvPipeline() {
    var lowerYCrCb: Scalar = Scalar(0.0, 0.0, 148.0, 0.0)
    var upperYCrCb: Scalar = Scalar(76.0, 129.0, 255.0, 0.0)
    private val ycrcbMat = Mat()
    private val ycrcbBinaryMat = Mat()

    var erodeValue: Int = 3
    var dilateValue: Int = 3
